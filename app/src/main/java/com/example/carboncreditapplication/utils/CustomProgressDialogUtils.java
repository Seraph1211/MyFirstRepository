...
public class CustomProgressDialogUtils extends Dialog implements DialogInterface.OnCancelListener {

    private WeakReference<Context> mContext = new WeakReference<>(null);
    private volatile static CustomProgressDialogUtils sDialog;

    private CustomProgressDialogUtils(Context context, CharSequence message) {
    ...
    public static synchronized void showLoading(Context context, CharSequence message, boolean cancelable) {
        ...
        sDialog = new CustomProgressDialogUtils(context, message);
